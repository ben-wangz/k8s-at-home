...
DEFAULT_MIN_VERSION="${FORGEKIT_MIN_VERSION:-0.6.0}"
DEFAULT_BEST_VERSION="${FORGEKIT_BEST_VERSION:-0.6.0}"
...
Arguments:
  min-version   Minimum acceptable forgekit version (default: FORGEKIT_MIN_VERSION or 0.6.0)
  best-version  Preferred forgekit version to download when install/upgrade is needed
                (default: FORGEKIT_BEST_VERSION or 0.6.0)
